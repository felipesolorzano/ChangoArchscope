...
export type DockerPhpcsScannerOptions = {
  /** Directorio que contiene el Dockerfile de la imagen de compatibilidad. */
 ...
 */
export class DockerPhpcsScanner implements PhpCompatibilityScanner {
  private readonly image: string;
  private readonly dockerfileDir: string;
  private readonly timeoutMs: number;

  constructor(options: DockerPhpcsScannerOptions) {
  ...
  private async runScan(repoPath: string, targetPhp: string, extensions: string, outDir: string): Promise<void> {
