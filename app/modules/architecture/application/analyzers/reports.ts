import type { ArchitectureCheckResult, ArchitectureIssue, ModuleCheckReport } from "../../domain/value-objects/ArchitectureCheckReport.js";
...
export function issue(input: IssueInput): ArchitectureIssue {
  const {
    module,
    layer,
    file,
...
export function report(input: ReportInput): ModuleCheckReport {
...
export function checkResponse(input: CheckResponseInput): ArchitectureCheckResult {
