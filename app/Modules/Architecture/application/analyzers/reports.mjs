...
export function report({ module, modulePath, scannedFiles, violations, couplings, failOnCoupling = false }) {
  return {
    module,
...
export function checkResponse({ target, module, reports, failOnCoupling, checkedAt }) {
  return {
