      ...
      Domain: [
        {
          ...
          suggestion: "Mueve hooks/componentes a interfaces y deja Domain con tipos/reglas puras.",
        },
        {
          pattern: "\\/infrastructure\\/",
          message: "Domain no debe depender de Infrastructure.",
        ...
        },
        {
          ...
          suggestion: "Mueve esa dependencia a interfaces o application.",
        },
      ],
      Application: [
        {
        ...
        {
          pattern: "\\/interfaces\\/",
          message: "Application no debe depender de interfaces/UI.",
